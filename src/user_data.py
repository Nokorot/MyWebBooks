importsrc.mongodb_api_1 as mongodb_api
fromflask import g, request, render_template, redirect, url_for

fromsrc.login import login_required

fromauth0.management import Auth0
fromauth0.authentication import GetToken

fromemail_validator import validate_email, EmailNotValidError
...
defset_kindle_address(kindle_address):

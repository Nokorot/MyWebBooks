...
fromflask import Blueprint, render_template, request, send_file, url_for
blueprint= Blueprint('royalroad_rss', __name__)


fromhtml_to_epub.RR_rss import load_datafile, getOldestNew, getChapters
fromsrc.sendToKindle import sendToKindle
